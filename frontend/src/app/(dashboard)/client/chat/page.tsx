...
export default function ClientChatPage() {
  return (
    <div className="flex flex-col h-[calc(100vh-8rem)]">
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-slate-900">Pesan & Konsultasi</h1>
        <p className="mt-1 text-sm text-slate-500">
          Berkomunikasi langsung dengan advokat yang menangani kasus Anda.
        </p>
      </div>
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="p-4 border-b border-slate-100 cursor-pointer bg-blue-50/50 hover:bg-slate-50 transition-colors">
              <div className="flex items-center justify-between mb-1">
                <span className="font-semibold text-sm text-slate-900">Budi Santoso, S.H.</span>
                <span className="text-xs text-slate-500">10:42</span>
              </div>
              <p className="text-xs text-blue-600 font-medium mb-1">Kasus: PRB-2026-01</p>
              <p className="text-sm text-slate-600 truncate">Baik, saya akan mempelajari dokumen yang dilampirkan terlebih dahulu...</p>
            </div>
            
            <div className="p-4 border-b border-slate-100 cursor-pointer hover:bg-slate-50 transition-colors">
              <div className="flex items-center justify-between mb-1">
                <span className="font-semibold text-sm text-slate-900">Admin Sistem</span>
                <span className="text-xs text-slate-500">Kemarin</span>
              </div>
              <p className="text-xs text-slate-500 font-medium mb-1">Verifikasi Berkas</p>
              <p className="text-sm text-slate-600 truncate">Berkas SKTM Anda telah berhasil kami verifikasi. Silakan...</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col h-full bg-slate-50">
          ...
          <div className="p-4 bg-white border-b border-slate-200 flex items-center justify-between shrink-0">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="font-semibold text-slate-900 text-sm">Budi Santoso, S.H.</h3>
                <p className="text-xs text-slate-500">Advokat - Menangani PRB-2026-01</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            <div className="flex justify-center my-4">
              <span className="px-3 py-1 bg-slate-200 text-slate-600 text-xs rounded-full font-medium">
                Sistem: Kasus PRB-2026-01 telah ditugaskan ke Advokat Budi Santoso, S.H.
              </span>
            </div>
            ...
            <div className="flex justify-end">
              <div className="bg-blue-600 text-white rounded-2xl rounded-tr-sm px-4 py-2 max-w-[80%] shadow-sm">
                ...
                <div className="mt-1 flex items-center justify-end text-[10px] text-blue-200">
                  10:30 <CheckCircle2 className="w-3 h-3 ml-1" />
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-end">
              <div className="bg-blue-600 text-white rounded-2xl rounded-tr-sm px-4 py-2 max-w-[80%] shadow-sm flex items-center cursor-pointer hover:bg-blue-700 transition">
                <div className="bg-white/20 p-2 rounded mr-3">
                  <FileText className="w-5 h-5 text-white" />
                </div>
                <div className="text-sm">
                  <p className="font-medium">Surat_Wasiat.pdf</p>
            ...
            <div className="flex justify-start">
              <div className="flex items-end">
                <div className="h-6 w-6 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 font-bold mr-2 mb-1 shrink-0 text-xs">
                  BS
                </div>
